...
public class TestHelpers {
  ...
  public static View getViewById(String resName) {
    ...
    InstrumentationBackend.log(">>> getViewById " + resName);
    ...
    InstrumentationBackend.log("getViewById id=" + id);
    
    View view;
    
    try {
      
      view = InstrumentationBackend.solo.getView(id);
      
    } catch (AssertionFailedError afe) {
      
      InstrumentationBackend.log("View not found " + afe.getMessage());
      afe.printStackTrace();
    ...
    InstrumentationBackend.log("getViewById <<<");
